...
def init_schema() -> None:
    ...
    constraints = [
        ...
        "CREATE CONSTRAINT noun_phrase_id IF NOT EXISTS FOR (n:NounPhrase) REQUIRE n.id IS UNIQUE",
        "CREATE CONSTRAINT modifier_id IF NOT EXISTS FOR (m:Modifier) REQUIRE m.id IS UNIQUE",
        "CREATE CONSTRAINT unresolved_reference_id IF NOT EXISTS FOR (u:UnresolvedReference) REQUIRE u.id IS UNIQUE",
    ...
    indexes = [
        ...
        "CREATE INDEX chapter_book IF NOT EXISTS FOR (c:Chapter) ON (c.book_id, c.number)",
        "CREATE INDEX paragraph_chapter IF NOT EXISTS FOR (p:Paragraph) ON (p.chapter_id, p.number)",
        "CREATE INDEX proposition_book_kind IF NOT EXISTS FOR (p:Proposition) ON (p.book, p.kind)",
        "CREATE INDEX proposition_predicate IF NOT EXISTS FOR (p:Proposition) ON (p.predicate_lemma)",
        "CREATE INDEX noun_phrase_head IF NOT EXISTS FOR (n:NounPhrase) ON (n.head)",
        "CREATE INDEX noun_phrase_passage IF NOT EXISTS FOR (n:NounPhrase) ON (n.passage_id)",
